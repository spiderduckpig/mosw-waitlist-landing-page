...
import {subscribe, unsubscribe} from "@/app/events/events";
...
export default function Lead() {
  ...
  useEffect(() => {
    subscribe("buttonClicked", () => {featureSection.current?.scrollIntoView({behavior: "smooth"})})

    return () => {
      unsubscribe("buttonClicked", () => {});
    }
  }, []);
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">What you're looking for</h2>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up"
              ...
              {/*<svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-comet" width="44"*/}
              {/*     height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#5D5DFF" fill="none"*/}
              ...
              {/*  <path d="M4 9l3.5 3.5"/>*/}
              {/*</svg>*/}
              <h4 className="h4 mb-2">Motivated</h4>
