...
export default function Hero() {
  ...
  const title = "Sincerely";

  const subtext = "Reach thousands of core customers with Sincerely";

  useEffect(() => {
    if (buttonRef.current) {
      console.log("attaching onclick event listener")
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <Image className="max-w-full mx-auto md:max-w-none h-auto" src={Logo} width={410} height={400} alt="Logo" />
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">{subtext}</p>
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              {/*<div data-aos="fade-up" data-aos-delay="400">*/}
              {/*  <a className="btn text-white bg-purple-600 hover:bg-purple-700 w-full mb-4 sm:w-auto sm:mb-0" href="#0" ref={buttonRef}>Start free trial</a>*/}
              {/*</div>*/}
